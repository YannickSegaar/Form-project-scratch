		...
		if (!form.valid) {
            return {
              ...
              body: {
                ...
                formData: form.data, // return the form data
              },
            };
          }
...
// Directly return the form object with a success message
return {
    form: {
      ...form, // Spread the existing form data
      message: 'Gegevens succesvol ontvangen!' // Add your success message
    }
  }
}
};