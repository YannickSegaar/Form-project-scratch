<!-- YRS: Dit is een copy van mijn dakoppervlak-form.svelte code, deze kan ik gebruiken om
code snippets uit te halen en te knippen en te plakken, deze kan zo verwijderd worden -->
